...
class AvatarEyesPicker extends StatelessWidget {
  const AvatarEyesPicker({Key? key}) : super(key: key);
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            bottom: 0,
                            child: SvgPicture.asset(
                              'assets/svgs/${avatarData.genderAsString}/${avatarData.genderAsString}_eyes_$i.svg',
                            ),
                          ),
                        ],
                      ),
